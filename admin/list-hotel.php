...
<table  align="center" class="table table-strid table-hover ">
   ...
   <tr>
     <td ><label class="ba">S.No</label></td>
	  <td ><label class="ba">Hotel</label></td>
...
?>	
  <tbody>
   <tr>
     ...
     <td ><a style="text-decoration:none" href="delete-hotel.php?delete=<?php echo $id;?>"><button type='button' class='btn btn-danger'>Delete</button></a>
<a style="text-decoration:none" href="edit-hotel.php?edit=<?php echo $id;?>" ><button type='button' class='btn btn-primary'>Edit</button></a> 
<a style="text-decoration:none" href="view-hotel.php?view=<?php echo $id;?>"><button type='button' class='btn btn-success'>view</button></a>
	 </td>
   </tr><?php } ?></tbody>
    </table>
</div>
